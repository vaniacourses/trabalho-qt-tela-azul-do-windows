...
<html lang="pt-BR" data-bs-theme="dark">
    <head>
        <meta charset="UTF-8">
        <title>Comprovante de Depósito - Banco ATM</title>
                        ...
                        <div class="col-md-8 col-lg-7">
                            <div class="login-box p-4 p-md-5">
                                <div class="text-center mb-4">
                                    ...
                                    <h4 class="mt-2">Depósito Realizado com Sucesso</h4>
                                ...
                                <ul class="list-group list-group-flush bg-transparent">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent text-white">
                                        <span>Agência:</span> <strong><%= conta.getAgencia()%></strong>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent text-white">
                                        <span>Conta:</span> <strong><%= conta.getNumero()%></strong>
                                    </li>
