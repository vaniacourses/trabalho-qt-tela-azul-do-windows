...
<%
    // Segurança: Verifica se o cliente está logado e se há um comprovante na requisição
...
<html lang="pt-BR" data-bs-theme="dark">
    <head>
        <meta charset="UTF-8">
        <title>Comprovante de Saque - Banco ATM</title>
                        ...
                        <div class="col-md-8 col-lg-7">
                            <div class="login-box p-4 p-md-5">
                                <div class="text-center mb-4">
                                    ...
                                    <h4 class="mt-2">Saque Realizado com Sucesso</h4>
                                ...
                                <ul class="list-group list-group-flush bg-transparent">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent text-white">
                                        <span>Tipo:</span> <span class="text-uppercase"><%= comprovante.getTipo()%></span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent text-white">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent text-white fs-5 fw-bold">
                                        <span>Valor Sacado:</span>
                                        <span class="text-success"><%= formatoMoeda.format(comprovante.getValor())%></span>
                                    </li>
                                </ul>
